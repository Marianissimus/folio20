<template>
  <div>
    <section-header :title="'Or find me here'" :fontSize="30" style="margin-bottom: 0" />
    <div id="mycontacts">
    <a href="https://github.com/Marianissimus">
    <figure>
      <span id="github">
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="228.5 253.5 30 30" enable-background="new 228.5 253.5 30 30" xml:space="preserve">
      <g>
      <path class="contactIcons" stroke="#FFF" d="M245.852,274.252c2.923-0.345,6.032-1.408,6.032-6.456c0-1.435-0.505-2.604-1.328-3.508
      c0.133-0.345,0.557-1.647-0.16-3.454c0,0-1.063-0.346-3.561,1.328c-1.063-0.292-2.231-0.479-3.321-0.479
      c-1.117,0-2.286,0.187-3.322,0.479c-2.524-1.674-3.587-1.328-3.587-1.328c-0.717,1.807-0.292,3.109-0.16,3.454
      c-0.824,0.903-1.329,2.073-1.329,3.508c0,5.048,3.109,6.111,6.032,6.456c-0.372,0.32-0.717,0.931-0.85,1.781
      c-0.744,0.318-2.684,0.93-3.853-1.09c0,0-0.691-1.248-1.993-1.328c0,0-1.302-0.026-0.106,0.797c0,0,0.877,0.398,1.462,1.912
      c0,0,0.797,2.525,4.463,1.729v2.258c0,0.346-0.266,0.744-0.93,0.639c-5.208-1.729-8.955-6.67-8.955-12.463
      c0-7.254,5.872-13.126,13.127-13.126c7.227,0,13.125,5.872,13.1,13.126c0,5.793-3.747,10.709-8.955,12.463
      c-0.665,0.133-0.93-0.266-0.93-0.639v-3.64C246.729,275.447,246.33,274.651,245.852,274.252L245.852,274.252z M258.5,268.514
      c0-8.291-6.723-15.014-14.986-15.014c-8.291,0-15.014,6.723-15.014,15.014c0,8.264,6.723,14.986,15.014,14.986
      C251.777,283.5,258.5,276.777,258.5,268.514L258.5,268.514z"/>
      </g>
      </svg>
      </span>
...
#mycontacts figure span svg{
  fill: rgba(255, 255, 255, .8) !important;
}

#mycontacts figure figcaption{
...
#mycontacts figure:hover span svg{
  fill: inherit!important;
  stroke: white;
  stroke-width: .25px;
}

#mycontacts figure:hover{
  background: rgba(1, 1, 1, .5);
  transition: all 0.1s ease-in-out;
}

#mycontacts figure:hover figcaption{
  color: white;
  transition: all 0.1s ease-in-out;
}

#mycontacts figure:hover path{
  stroke: white;
}

figure #fcc figcaption, figure #facebook figcaption{
  margin-left: auto;
  margin-right: auto;
}

#codewars, #codepen, #freeCodeCamp, #github, #linkedin{
  fill: white;
}
